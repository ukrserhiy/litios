...
**LITI** (Linguistic Interview Trait Identifier) — self-hosted інструмент для психолінгвістичного аналізу транскриптів інтерв'ю. Визначає особистісні риси кандидатів на основі мовних маркерів, використовуючи AI моделі через [OpenRouter](https://openrouter.ai/).
...
- **Гнучкий вибір моделей**: від безкоштовних (Gemini) до преміум (Claude, GPT-4)
