...
<p align="center">
  <img src="LITI.jpg" alt="LITI Logo" width="200">
</p>

**LITI** (Linguistic Interview Trait Identifier) — інструмент для психолінгвістичного аналізу транскриптів інтерв'ю. Визначає особистісні риси кандидатів на основі мовних маркерів, використовуючи AI моделі через [OpenRouter](https://openrouter.ai/).
...
Детальні інструкції для деплою на різні платформи — див. [DEPLOY.md](DEPLOY.md)
...
```
litios/
├── server.py           # Flask сервер та API
├── index.html          # Весь фронтенд (HTML/CSS/JS)
├── data/
│   └── prompts.json    # Налаштування шкал та моделей
...
| Метод | Шлях | Опис |
|-------|------|------|
| GET | `/api/prompts` | Отримати всі налаштування |
| POST | `/api/prompts` | Зберегти налаштування |
